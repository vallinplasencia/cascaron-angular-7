...
@Component({
  selector: 'app-mis-actividades-asignadas-mostrar',
  templateUrl: './mis-actividades-asignadas-mostrar.component.html',
  styleUrls: ['./mis-actividades-asignadas-mostrar.component.css']
})
export class MisActividadesAsignadasMostrarComponent implements OnInit {
